(function() {
    ...
    function fb(k) {
        if (k._menuButton) k.exportEnabled ? Ja(k._menuButton) : ta(k._menuButton);
            ...
            V(k._menuButton, "touchstart", function(k) {
                m = !0
            ...
            V(k._menuButton, "mouseover", function() {
                m || (oa(k._menuButton, {
                    backgroundColor: k.toolbar.backgroundColorOnHover,
                    color: k.toolbar.fontColorOnHover
                }), 0 >= navigator.userAgent.search("MSIE") && oa(k._menuButton.childNodes[0], {
            ...
            V(k._menuButton, "mouseout", function() {
                m || (oa(k._menuButton, {
                    ...
                    navigator.userAgent.search("MSIE") && oa(k._menuButton.childNodes[0], {
    ...
    function ua(k, m, v) {
        m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor, m.style.color = k.toolbar.fontColor, m.style.border = "none", oa(m, {
        ...
        m.getAttribute("state") !==
            v && (m.setAttribute("state", v), m.setAttribute("type", "button"), oa(m, {
                padding: "5px 12px",
                cursor: "pointer",
                "float": "left",
                width: "40px",
                ...
                lineHeight: "0"
            }), m.setAttribute("title", k._cultureInfo[v + "Text"]), m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + ib[v].image + "' alt='" + k._cultureInfo[v + "Text"] + "' />")
    }
    ...
    function xa(k, m) {
        ...
        if (s(this.options.margin) && k.options.subtitles)
            for (var v = k.options.subtitles, u = 0; u < v.length; u++)
                if ((s(v[u].horizontalAlign) && "center" === this.horizontalAlign || v[u].horizontalAlign === this.horizontalAlign) && (s(v[u].verticalAlign) && "top" === this.verticalAlign || v[u].verticalAlign === this.verticalAlign) && !v[u].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    (function() {
        ...
        J.pro = {
            sCH: pa[J.fSDec("Bi`su")][J.fSDec("bsdehuIsdg")]
        };
        J._fTWm = function(k) {
    ...
    var eb = function() {
        ...
        ea = function(k, m, v) {
            ...
            for (Q = E = L = J = N = 0; 0 < M.length;)
                ...
                "") : m.replace("-", ""), v += m.replace(/[0]+/, function(a) {
                return $(W, a.length)
            }));
            y = "";
            for (M = !1; 0 < I.length;) m = I.shift(), "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ? (y += k.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function(a) {
                return $(W, a.length)
            }));
            v += (M ? u : "") + y;
            return s ? "-" + v : v
    ...
    W.prototype.isBeingTracked = function(k) {
        this.options._oldOptions || (this.options._oldOptions = {});
        return this.options._oldOptions[k] ? !0 : !1
    };
    W.prototype.hasOptionChanged = function(k) {
        if (!this.sessionVariables) throw "Session Variable Store not set";
    ...
    Ca.prototype.registerSpace = function(k, m) {
    ...
    Ca.prototype.unRegisterSpace = function(k, m) {
        "top" === k ? this._topOccupied -= m.height : "bottom" === k ? this._bottomOccupied -= m.height : "left" === k ? this._leftOccupied -= m.width : "right" === k && (this._rightOccupied -= m.width)
    };
    ...
    Sa.prototype.release = function(k) {
        this.pool.push(k)
    };
    na(Ha, W);
    var Na = {
        ...
        formatNumber: function(k, m, s) {
            s = s || "en";
            if (Ia[s]) return ea(k, m || "#,##0.##", new Ha(s));
            throw "Unknown Culture Name";
        },
        formatDate: function(k, m, s) {
            s = s || "en";
            if (Ia[s]) return za(k, m || "DD MMM YYYY", new Ha(s));
            throw "Unknown Culture Name";
        }
    };
    "undefined" !== typeof module &&
        "undefined" !== typeof module.exports ? module.exports = Na : "function" === typeof define && define.amd ? define([], function() {
            return Na
    ...
    y = Na.Chart = function() {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
                ...
                (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Aa(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Aa(this._preRenderCtx), u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
                    this.overlaidCanvas = sa(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
                        "top", Aa(this.overlaidCanvasCtx)), this._eventManager = new da(this), this.windowResizeHandler = V(window, "resize", function() {
                        ...
                        this.allDOMEventHandlers), V(this.overlaidCanvas, "mousemove", function(a) {
                        b._mouseEventHandler(a)
                    }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mouseup", function(a) {
                        b._mouseEventHandler(a)
                    }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mousedown", function(a) {
                        b._mouseEventHandler(a);
                        ta(b._dropdownMenu)
                    }, this.allDOMEventHandlers), V(this.overlaidCanvas, "mouseout", function(a) {
                        b._mouseEventHandler(a)
                    }, this.allDOMEventHandlers), V(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" :
                        "touchstart",
                        function(a) {
                            b._touchEventHandler(a)
                        }, this.allDOMEventHandlers), V(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerMove" : "touchmove", function(a) {
                        b._touchEventHandler(a)
                    }, this.allDOMEventHandlers), V(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend", function(a) {
                        b._touchEventHandler(a)
                    }, this.allDOMEventHandlers), V(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function(a) {
                        b._touchEventHandler(a)
                    }, this.allDOMEventHandlers),
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    var A = (a[p].x - a[f].x) / b;
                    b = (a[p].y - a[f].y) / b;
                    c[c.length] = a[l].x > a[f].x && 0 < A || a[l].x < a[f].x && 0 > A ? {
                        x: a[l].x + A / 3,
                        y: a[l].y + b / 3
                    } : {
                        x: a[l].x,
        ...
        m.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                ...
                }, this.allDOMEventHandlers), V(this._resetButton, "mouseover", function() {
                    d || (oa(a._resetButton, {
                        backgroundColor: a.toolbar.backgroundColorOnHover,
                ...
                }, this.allDOMEventHandlers), V(this._resetButton, "mouseout", function() {
                    d || (oa(a._resetButton, {
                        backgroundColor: a.toolbar.backgroundColor,
                        color: a.toolbar.fontColor,
                        transition: "0.4s",
        ...
        m.prototype.setLayout = function() {
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    u ? (this._breaksCanvas = sa(this.width, this.height, !0), this._breaksCanvasCtx = this._breaksCanvas.getContext("2d")) : (this._breaksCanvas = this.canvas, this._breaksCanvasCtx = this.ctx);
                    break
                }
            ...
            for (var b, e = this, f = !1, p = 0; p < this._axes.length; p++)
                if (this._axes[p].scaleBreaks && this._axes[p].scaleBreaks.autoCalculate && 1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) ||
                            10, 10); l++) this._axes[p].dataInfo._dataRanges.push({
                        min: Infinity,
                        max: -Infinity
                    })
                }
            if (f) {
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        this._axes[p].scaleBreaks._appliedBreaks.sort(function(a, b) {
                            return a.startValue - b.startValue
                        })
                    }
            }
        ...
        m.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag &&
                ...
                if ((!e || 2 < Math.abs(c) ||
                    ...
                    }, clearTimeout(p._panTimerId), p._panTimerId = setTimeout(function(b, c, e, f) {
                        return function() {
            ...
            for (p = 0; p < h.length; p++) {
                ...
                if (isFinite(r.dataInfo.minDiff))
                    if (w = r.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && w < Math.pow(r.dataInfo.minDiff,
                            3) || !r.logarithmic && w < 3 * Math.abs(r.dataInfo.minDiff)) || q < r.minimum || g > r.maximum)) A.push(r), n.push({
                        val1: q,
                        val2: g
                    }), l = !0;
                    else if (!e) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== z && "" !== z) {
                    ...
                    if ("stackedarea100" === n) {
                        ...
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < C.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > C.viewportMaximum) continue
                    ...
                    } else if (0 <= n.indexOf("column") || "waterfall" === n || "error" === n && !h.axisSwapped) {
                        ...
                        for (var F = !1, t = 0; t < n.length; t++)
                            if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !F)))
                                if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || F || m) && (c.stroke(), u && b.stroke()), F = !0;
                                    ...
                                    }(n[t].indexLabel || h.indexLabel || n[t].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "line",
                                        dataPoint: n[t],
                                        dataSeries: h,
                                        point: {
                        ...
                        for (var F = !1, t = 0; t < n.length; t++)
                            if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !F)))
                                if ("number" !== typeof n[t].y) 0 < t && !(h.connectNullData || F || m) && (c.stroke(),
                                    ...
                                    if (0 < n[t].markerSize || 0 < h.markerSize) B = h.getMarkerProperties(t, x, s, c), f.push(B), C = P(C), u && f.push({
                                        x: x,
                                        y: s,
                                        ctx: b,
                                        type: B.type,
                        ...
                        for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < w.length; f++)
                            if (w[f].getTime ? A = w[f].x.getTime() :
                                ...
                                (w[f].indexLabel || g.indexLabel || w[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    point: {
                                        x: p + (m - p) / 2,
                                        y: 0 > w[f].y === a.axisY.reversed ? l : t
                                    },
        ...
        m.prototype.renderArea = function(a) {
            ...
            function b() {
                B && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? F = z : 0 > a.axisY.viewportMaximum ? F = l.y1 : 0 < a.axisY.viewportMinimum && (F = z), f.lineTo(m, F), f.lineTo(B.x, F), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, u && (p.lineTo(m, F), p.lineTo(B.x, F), p.closePath(), p.fill()), f.beginPath(), f.moveTo(m, t), p.beginPath(), p.moveTo(m, t), B = {
                    x: m,
                    y: t
                })
            }
                            ...
                            if (s = w[k].x.getTime ? w[k].x.getTime() : w[k].x, !(s < a.axisX.dataInfo.viewPortMin ||
                                ...
                                if ("number" !== typeof w[k].y) g.connectNullData || (ja || d) || b(), ja = !0;
                                    ...
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, B = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, t), u && p.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), u &&
                                        (p.beginPath(), p.moveTo(m, t)), B = {
                                            x: m,
                                            y: t
                                        }), ja = d = !1) : (f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b());
                                    n = {
                                        x: m,
                                        y: t
                                    };
                                    ...
                                    0 !== w[k].markerSize &&
                                        (0 < w[k].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(k, m, t, f), A.push(s), Z = P(Z), u && A.push({
                                            x: m,
                                            y: t,
                                            ctx: p,
                                            type: s.type,
                                    ...
                                    (w[k].indexLabel || g.indexLabel || w[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "area",
                                        dataPoint: w[k],
                                        dataSeries: g,
                                        point: {
                        ...
                        for (w = !1; q < r.length; q++)
                            if (g = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !w)))
                                if ("number" !== typeof r[q].y) 0 < q && !w && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y,
                                    ...
                                    if (0 !== r[q].markerSize && (0 < r[q].markerSize || 0 < n.markerSize)) {
                                    ...
                                    }(r[q].indexLabel || n.indexLabel || r[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                        ...
                                        direction: 0 > r[q].y === a.axisY.reversed ? 1 : -1,
                                        color: z
                                    });
                                    w = !1
                                }
        ...
        m.prototype.renderStepArea = function(a) {
            ...
            function b() {
                B && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? F = z : 0 > a.axisY.viewportMaximum ? F = l.y1 : 0 < a.axisY.viewportMinimum && (F = z), f.lineTo(m, F), f.lineTo(B.x, F), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, u && (p.lineTo(m, F), p.lineTo(B.x, F), p.closePath(), p.fill()),
                    f.beginPath(), f.moveTo(m, t), p.beginPath(), p.moveTo(m, t), B = {
                        x: m,
                        y: t
                    })
            }
                        ...
                        for (; k <
                            ...
                            if (s = w[k].x.getTime ? w[k].x.getTime() : w[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                ...
                                "number" !== typeof w[k].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(w[k].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, B = n, S = g.nullDataLineDashType,
                                        f.setLineDash(R)), f.lineTo(m, Z), f.lineTo(m, t), u && (p.lineTo(m, Z), p.lineTo(m, t))) : (f.beginPath(), f.moveTo(m, t), u && (p.beginPath(), p.moveTo(m, t)), B = {
                                        x: m,
                                        y: t
                                    }), c = d = !1) : (f.lineTo(m, Z), u && p.lineTo(m, Z), f.lineTo(m, t), u && p.lineTo(m, t), 0 == k % 250 && b()), n = {
                                        x: m,
                                        y: t
                                    }, k < w.length - 1 && (y !== (w[k].lineColor || v) || S !== (w[k].lineDashType || g.lineDashType)) && (b(), y = w[k].lineColor || v, f.strokeStyle = y, f.setLineDash && (w[k].lineDashType ? (S = w[k].lineDashType, f.setLineDash(N(S, g.lineThickness))) : (S = g.lineDashType, f.setLineDash(D)))),
                                    s = g.dataPointIds[k], this._eventManager.objectMap[s] = {
                                        id: s,
                                        objectType: "dataPoint",
                                        dataSeriesIndex: q,
                                        dataPointIndex: k,
                                        x1: m,
                                        y1: t
                                    }, 0 !== w[k].markerSize && (0 < w[k].markerSize || 0 < g.markerSize) && (Z = g.getMarkerProperties(k, m, t, f), A.push(Z), s = P(s), u && A.push({
                                        x: m,
                                        y: t,
                                        ctx: p,
                                        type: Z.type,
                ...
                for (F = 0; F < a.dataSeriesIndexes.length; F++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                fa = null,
                                fa = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof fa.y) C.connectNullData || (Z || x) || d(), Z = !0;
                                    ...
                                    x || Z ? (!x && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || z === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (x = h.pop(), z = h[h.length - 1], d(), b.moveTo(t.x, t.y), h.push(z), h.push(x), z = C.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, k), u && s.lineTo(g, k)) : (b.beginPath(), b.moveTo(g, k), u && (s.beginPath(),
                                        s.moveTo(g, k))), Z = x = !1) : (b.lineTo(g, k), u && s.lineTo(g, k), 0 == q % 250 && (d(), b.moveTo(g, k), u && s.moveTo(g, k), h.push({
                                        x: g,
                                        y: m - ma
                                    })));
                                    t = {
                                    ...
                                    q < v.length - 1 && (S !== (v[q].lineColor || y) || z !== (v[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({
                                        x: g,
                                        y: m - ma
                                    }), S = v[q].lineColor || y, b.strokeStyle = S, b.setLineDash && (v[q].lineDashType ? (z = v[q].lineDashType, b.setLineDash(N(z, C.lineThickness))) : (z = C.lineDashType, b.setLineDash(D))));
                                    ...
                                    0 <= C.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < C.markerSize) && (ma = C.getMarkerProperties(C.dataPointIndexes[f], g, k, b), p.push(ma), f = P(E), u && p.push({
                                        x: g,
                                        y: k,
                                        ctx: s,
                                        type: ma.type,
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                fa = null,
                                fa = 0 <= C.dataPointIndexes[f] ? y[C.dataPointIndexes[f]] : {
                                    x: f,
                                    y: null
                                };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof fa.y) C.connectNullData || (Z || s) || d(), Z = !0;
                                    ...
                                    s || Z ? (!s && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || t === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (s = h.pop(), t = h[h.length - 1], d(), b.moveTo(m.x,
                                        m.y), h.push(t), h.push(s), t = C.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, w), u && z.lineTo(g, w)) : (b.beginPath(), b.moveTo(g, w), u && (z.beginPath(), z.moveTo(g, w))), Z = s = !1) : (b.lineTo(g, w), u && z.lineTo(g, w), 0 == q % 250 && (d(), b.moveTo(g, w), u && z.moveTo(g, w), h.push({
                                        x: g,
                                        y: x - ba
                                    })));
                                    m = {
                                    ...
                                    q < y.length - 1 && (S !== (y[q].lineColor || D) || t !== (y[q].lineDashType || C.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, w), h.push({
                                        x: g,
                                        y: x - ba
                                    ...
                                    0 <= C.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < C.markerSize) && (ba = C.getMarkerProperties(q, g, w, b), l.push(ba), f = P(G), u && l.push({
                                        x: g,
                                        y: w,
                                        ctx: z,
                                        type: ba.type,
                        ...
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                ...
                                (q[e].indexLabel || r.indexLabel ||
                                    q[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "bubble",
                                    dataPoint: q[e],
                                    dataSeries: r,
                                    point: {
                        ...
                        for (var r = 0, q = 0, e = 0; e < n.length; e++)
                            if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                                ...
                                Math.sqrt((r - f) * (r - f) + (q - p) * (q - p)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (r = h.dataPointIds[e], this._eventManager.objectMap[r] = {
                                    ...
                                    x1: f,
                                    y1: p
                                }, r = P(r), u && X.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, r, r, g.borderThickness), (n[e].indexLabel || h.indexLabel || n[e].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: n[e],
                                    dataSeries: h,
                                    point: {
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    ...
                    if (0 < B.length)
                        for (var E = F._colorSet,
                            ...
                            var R = {
                                color: B[l].stemColor ? B[l].stemColor : B[l].color ? F.stemColor ? F.stemColor : B[l].color : F.stemColor ? F.stemColor : e,
                                thickness: B[l].stemThickness ? B[l].stemThickness : F.stemThickness,
                                dashType: B[l].stemDashType ? B[l].stemDashType : F.stemDashType
                            };
                            R.thickness =
                            ...
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !s(B[l].y) && B[l].y.length && "number" === typeof B[l].y[0] && "number" === typeof B[l].y[1]) {
                                ...
                                if (B[l].indexLabel || F.indexLabel || B[l].indexLabelFormatter || F.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "error",
                                    dataPoint: B[l],
                                    dataSeries: F,
                                    indexKeyword: 0,
                                    point: {
                                        x: b ? B[l].y[1] >= B[l].y[0] ? n : r : n + (r - n) / 2,
                                        y: b ? q + (g - q) / 2 : B[l].y[1] >= B[l].y[0] ? g : q
                                    },
                                    ...
                                    indexKeyword: 1,
                                    point: {
                                        x: b ? B[l].y[1] >= B[l].y[0] ? r : n : n + (r - n) / 2,
                                        y: b ? q + (g - q) / 2 : B[l].y[1] >= B[l].y[0] ? q : g
                                    },
                                    direction: B[l].y[1] >= B[l].y[0] ? 1 : -1,
                                    bounds: {
                                        x1: b ? Math.min(n, r) : n,
                            ...
                            if (t = r[g].x.getTime ?
                                ...
                                if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                                    ...
                                    q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, C = n.nullDataLineDashType,
                                        b.setLineDash(y)), b.lineTo(m, s), u && e.lineTo(m, s), k.push({
                                        x: m,
                                        y1: s,
                                        y2: v
                                    })) : (b.beginPath(), b.moveTo(m, s), x = {
                                        x: m,
                                        y: s
                                    }, k = [], k.push({
                                        x: m,
                                        y1: s,
                                        y2: v
                                    }), u && (e.beginPath(), e.moveTo(m, s))), S = q = !1) : (b.lineTo(m, s), k.push({
                                        x: m,
                                        y1: s,
                                        y2: v
                                    }), u && e.lineTo(m, s), 0 == g % 250 && d());
                                    t = n.dataPointIds[g];
                                    this._eventManager.objectMap[t] = {
                                        id: t,
                                        objectType: "dataPoint",
                                    ...
                                    if (r[g].indexLabel || n.indexLabel || r[g].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: r[g],
                                        dataSeries: n,
                                        indexKeyword: 0,
                                        ...
                                        direction: r[g].y[0] > r[g].y[1] === a.axisY.reversed ? -1 : 1,
                                        color: z
                                    }), this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: r[g],
                        ...
                        for (g = !1; r < n.length; r++)
                            if (q = n[r].x.getTime ? n[r].x.getTime() : n[r].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                                if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" ===
                                    ...
                                    if (n[r].indexLabel ||
                                        h.indexLabel || n[r].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({
                    ...
                    if (0 < v.length)
                        for (var z = 5 < q && s.bevelEnabled ? !0 : !1, F = !1, B = null, C = null, p = 0; p < v.length; p++)
                            if (v[p].getTime ? n = v[p].x.getTime() : n = v[p].x, "number" !== typeof v[p].y) {
                                ...
                                (v[p].indexLabel || s.indexLabel || v[p].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "waterfall",
                                    dataPoint: v[p],
                                    dataSeries: s,
                                    point: {
            ...
            function d() {
                if (h &&
                    ...
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        if (h.indexLabelFormatter || f.indexLabelFormatter) m = {
                            chart: k.options,
                            dataSeries: h,
                            dataPoint: f,
                            total: r.total,
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function b() {
                if (t && x) {
                    for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, w = [], A = [], v = {
                            percent: null,
                            total: null
                        }, B = null, z = 0; z < x.length; z++) m = O[z], m = "undefined" !== typeof m.x5 ?
                    ...
                    for (var z = 0, C = x.length - 1; z < x.length || 0 <= C; z++, C--) {
                        ...
                        if (t.indexLabelFormatter || b.indexLabelFormatter) B = {
                            chart: y.options,
                            dataSeries: t,
                            dataPoint: b,
                            total: v.total,
            ...
            function p() {
                ...
                function b() {
                    ...
                    for (var l, p = 1; p < h; p++) {
                        e = p * f;
                        for (var n = H.length - 1; 0 <= n; n--) !H[n].isDirty && (H[n].textBlock.y < e && H[n].textBlock.y + H[n].height > e) && (l = q(n), !(l >= H.length - 1) && H[n].textBlock.y + H[n].height + da > H[l].textBlock.y && (H[n].textBlock.y = H[n].textBlock.y + H[n].height - e > e - H[n].textBlock.y ? e + 1 : e - H[n].height - 1))
                    }
            ...
            function k(a, b, c) {
                var d, e, g, l = [],
                    p = F,
                    r = []; - 1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b), Y.splice(e, 1)) : (Y.push(b), Y = Y.sort(function(a, b) {
                    return a - b
                })));
                if (0 === Y.length) l = ga;
                else {
                ...
                var s = {
                    ...
                    changeSection: function(a) {
                        for (var b, c, d = 0; d < O.length; d++) b = g[d], c = O[d], b *= a, "undefined" === typeof r[d] && (r[d] = 0), 0 > r && (r *= -1), c.y1 += b - r[d], c.y2 += b - r[d], c.y3 += b - r[d], c.y4 += b - r[d], c.y5 && (c.y5 += b - r[d], c.y6 += b - r[d]), r[d] = b
                    }
                };
                    ...
                    if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                        ...
                        for (var x = 0; x < r.dataPoints.length; x++) {
                            var z = r.dataPoints[x],
                                ...
                                g = z.legendText ? z.legendText : r.legendText ? r.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                    chart: this.chart,
                                    legend: this.options,
                                    dataSeries: r,
                                    dataPoint: z
                ...
                for (n = 0; n < k.length; n++) {
                    ...
                    if (!(0 >= p || "undefined" ===
                        ...
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!r || r.width + Math.round(q.textBlock.width + u + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) r = {
                                items: [],
                                width: 0
                            }, h.push(r), this.height += g, g = 0;
                            ...
                            fontStyle: this.fontStyle,
                            textBaseline: "middle"
                        }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (u + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < p - this.lineHeight ? (r = {
                            items: [],
                            width: 0
                        }, h.push(r)) : (r = h[x], x = (x + 1) % h.length), this.height += q.textBlock.height;
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                m < q.radius && m > u && (m = Math.atan2(d - s.y, a - s.x), 0 > m && (m += 2 * Math.PI), m = Number(((180 * (m / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (q.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), u = Number(((180 * (q.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < q.endAngle && (u = 360), s >= u && 0 !== g.y && (u += 360, m < s && (m += 360)), m > s && m < u && (b.push({
                                    dataPoint: g,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
                ...
                for (var x = [], z = [], y = [], B = [], M = [], N = [], P = [], Q = []; 4 > u;) {
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) a[g] && (a[g].lineCoordinates.x1 = p, k = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), a[g]._labels && 1 < a[g]._labels.length && (l = h = 0, h = a[g]._labels[1], l = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length -
                            ...
                            a[g].tickPlacement ? a[g].tickLength : 0), a[g].lineCoordinates.y2 = a[g].lineCoordinates.y1 + a[g].lineThickness / 2), a[g].bounds = {
                            x1: p,
                            y1: l,
                            x2: k,
                            y2: h - (U + e - x[g] - G),
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(k - p), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], l = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length -
                            ...
                            X, l = Math.round(f.y1), h = Math.round(f.y2 + d[g].margin), d[g].lineCoordinates.y1 = l + X + Y - V, d[g].lineCoordinates.y2 = l, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - z[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)), d[g].bounds = {
                                x1: p,
                                y1: l + (X + Y - z[g] - V),
                                x2: k,
                                y2: h,
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++) K = n.isNavigator ? 0 : 10, c[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ?
                            c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : r, l = Math.round(f.y1 + X + Y < Math.max(K, r) ? Math.max(K, r) : f.y1 + X + Y), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : r, h = Math.round(f.y2 - U - e - K), c[g].lineCoordinates = {
                                x1: p - T,
                                y1: l,
                                x2: k - T,
                                y2: h,
                                height: Math.abs(h - l)
                            }, "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (y[g] - c[g]._titleTextBlock ? c[g]._titleTextBlock.height :
                                0) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0), c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2), c[g].bounds = {
                                x1: p - (y[g] + T),
                                y1: l,
                                x2: k,
                                y2: h,
                                width: k - p,
                                height: h - l
                            }, c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), T += y[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), k = Math.round(p), K =
                            b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, l = Math.round(f.y1 + X + Y < Math.max(K, r) ? Math.max(K, r) : f.y1 + X + Y), K = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, h = Math.round(f.y2 - (U + e + K)), b[g].lineCoordinates = {
                                x1: p + W,
                                y1: l,
                                x2: p + W,
                                y2: h,
                                height: Math.abs(h - l)
                            }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (B[g] - b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) - ("outside" === b[g].tickPlacement ?
                                b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = {
                                x1: p,
                                y1: l,
                                x2: k + (B[g] + W),
                                y2: h,
                                width: k - p,
                                height: h - l
                            }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth : b[g].lineCoordinates.height), W += B[g] + b[g].margin);
                    if (a && 0 < a.length)
                ...
                for (N = []; 4 > u;) {
                    ...
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--) l = Math.round(f.y2), h = Math.round(f.y2 > c[g].chart.height ?
                            ...
                            x1: p,
                            y1: l - (r[g] + X + c[g].margin),
                            x2: k,
                            y2: h - (X + c[g].margin),
                            width: k - p,
                            height: r[g]
                        }, c[g].title && (c[g]._titleTextBlock.maxWidth =
                    ...
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--) b[g] && (l = Math.round(f.y1), h = Math.round(f.y1 + (C[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                            x1: p,
                            y1: l + (b[g].margin + G),
                            x2: k,
                            y2: h,
                            width: k - p,
                            height: V
                        }, b[g].title && (b[g]._titleTextBlock.maxWidth =
            ...
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                if (!k) {
                    ...
                    for (b = 0; b < m.length; b++) c = m[b], c.stripLine.showOnTop ?
                        k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                            for (e = 0; e < m.length; e++) c = m[e], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore())
                ...
                if (k)
                    for (k = !1, b = 0; b < m.length; b++) c = m[b], c.stripLine.showOnTop ?
                        k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                            for (e = 0; e < m.length; e++) c = m[e], "outside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && c.textBlock.render(!0)
        ...
        D.prototype.renderCrosshair = function(a, d) {
            isFinite(this.minimum) && isFinite(this.maximum) &&
                (this.crosshair.render(a, d), this.crosshair.dispatchEvent("updated", {
                    chart: this.chart,
                        ...
                        if (!(e[c].endValue < this.conversionParameters.minimum))
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (1 <
                                        e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) < e[c].endValue) {
                                ...
                                if (d)
                                    if (e[c].endValue > this.conversionParameters.minimum) {
                                        if (1 < e[c].size && this.conversionParameters.minimum * Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size)) > e[c].startValue) {
                                            a = Math.pow(e[c].endValue / e[c].startValue, Math.log(b) / Math.log(e[c].size));
                                            break
                                        } else a *= e[c].startValue / this.conversionParameters.minimum * Math.pow(e[c].size,
                            ...
                            if (d)
                                if (e[c].startValue < this.conversionParameters.minimum) {
                                    if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size < e[c].endValue) {
                                        ...
                                        break
                                    } else a += e[c].endValue - this.conversionParameters.minimum - e[c].size * (e[c].endValue - this.conversionParameters.minimum) / (e[c].endValue - e[c].startValue), b -= e[c].size * (e[c].endValue -
                                ...
                                if (d)
                                    if (e[c].endValue > this.conversionParameters.minimum)
                                        if (e[c].size && this.conversionParameters.minimum + b * (e[c].endValue - e[c].startValue) / e[c].size > e[c].startValue) {
                                            a = 0 >= e[c].size ? 0 : b * (e[c].endValue - e[c].startValue) / e[c].size;
                                            break
                                        } else a += e[c].startValue - this.conversionParameters.minimum + e[c].size * (this.conversionParameters.minimum -
            ...
            if (this.scaleBreaks)
                for (k =
                    ...
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[k].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[k].startValue) && (!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue ||
                            !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[k].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[k].endValue)) {
        ...
        U.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === r % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + r / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b - r / 2,
                            y1: e,
                            x2: k + r / 2,
                            y2: l
                    ...
                    if (e = 1 === r % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === r % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + r / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
                            k = this.chart.plotArea.x1 - r / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b,
                            y1: e - r / 2,
                            x2: k,
                            y2: l + r / 2
                        }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(k, e), this.ctx.lineTo(k, l), this.ctx.lineTo(b, l);
                    else if ("wavy" === this.type) {
                    m = b;
                    h = e;
                    f = 0.5;
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                else if ("left" === this.parent._position || "right" === this.parent._position) k = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, f = this.chart.plotArea.x2, this.bounds = {
                    x1: e,
                    y1: k - d / 2,
                    x2: f,
                    y2: l + d / 2
        ...
        aa.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[v].type || "error" === this.parent.dataSeries[v].type) {
                            ...
                            0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : x.dataPoint.y
                        ...
                        if (y) {
                            if ("axisX" === this.parent.type)
                                for (w = this.parent.convertPixelToValue({
                                        y: d
                                    }), u = null, v = 0; v < this.parent.dataSeries.length; v++)(u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: x.dataPoint.x
                            ...
                            }) : s(this.options.label) ? za(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: c ? c : x.dataPoint.x
                            }) : s(this.options.label) ? ea(c ? c : x.dataPoint.x, this.valueFormatString,
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[v].type || "rangeArea" === this.parent.dataSeries[v].type || "error" === this.parent.dataSeries[v].type || "rangeSplineArea" === this.parent.dataSeries[v].type || "candlestick" === this.parent.dataSeries[v].type || "ohlc" === this.parent.dataSeries[v].type ||
                        ...
                        this.parent.dataSeries[v].type ? (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum
                        }) : s(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString,
                            this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (m = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: x.dataPoint.y
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = {
                    x1: b - r / 2,
                    y1: f,
                    x2: e + r / 2,
                    y2: k
                };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = k = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = {
                    x1: b,
                    y1: f - r / 2,
                    x2: e,
                    y2: k + r / 2
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        }) : s(this.options.label) ? za(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(d)
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) h.text = this.labelFormatter ?
                            this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: c ? c : this.parent.convertPixelToValue(a)
                            }) : s(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label, h.x = b - h.measureText().width / 2, h.x + h.width > this.chart.bounds.x2 && (h.x = this.chart.bounds.x2 - h.width), h.x < this.chart.bounds.x1 && (h.x = this.chart.bounds.x1), "bottom" === this.parent._position ? h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2 : "top" === this.parent._position &&
                    ...
                    if (y) {
                        if ("axisX" === this.parent.type)
                            for (w = this.parent.convertPixelToValue({
                                    x: a
                                }), u = null, v = 0; v < this.parent.dataSeries.length; v++)(u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ?
                                this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: c ? c : this.parent.convertPixelToValue(a)
                                }) : s(this.options.label) ? c ? c : u.dataPoint.label : this.label)
                    } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                        }) : s(this.options.label) ? za(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label :
                        "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                    ...
                    "bottom" === this.parent._position ? h.y = this.parent.lineCoordinates.y2 + h.fontSize / 2 + 2 : "top" === this.parent._position && (h.y = this.parent.lineCoordinates.y1 - h.height + h.fontSize / 2 + 2)
                        ...
                        crosshair: this.options,
                        value: c ? c : this.parent.convertPixelToValue(d)
                    }) : s(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) :
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var k = this.chart.axisX[m].convertPixelToValue({
                                        y: d
                                    }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b], null !== h.dataPoint.y && l.push(h));
                                h = null
                            }
                        if (this.chart.axisX2)
                            for (m =
                                0; m < this.chart.axisX2.length; m++) {
                                k = this.chart.axisX2[m].convertPixelToValue({
                                    y: d
                                });
                                h = null;
                        ...
                        if (this.chart.axisX)
                            for (m = 0; m < this.chart.axisX.length; m++)
                                for (k = this.chart.axisX[m].convertPixelToValue({
                                        x: a
                                    }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k,
                        ...
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++)
                                for (k = this.chart.axisX2[m].convertPixelToValue({
                                        x: a
                                    }), h = null, b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)(h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== h.dataPoint.y && l.push(h))
                    }
